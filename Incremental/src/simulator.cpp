...
public:
    ...
    std::vector<InstanceData> _fireData;
...
private:
    ...
    ******************************************************************************************************************/
    ...
    Shaders::PhongGL _fireShader;
    GL::Mesh _voxelMesh{NoCreate};
    GL::Mesh _fireMesh{NoCreate};
...

{
    ...
    //MeshTools::transform3DInPlace(*_meshData, Matrix4::translation({1, 0, 1}));
    ...
    _fireMesh = MeshTools::compile(Primitives::cubeSolid());
    _fireShader = Shaders::PhongGL{Shaders::PhongGL::Flag::VertexColor | Shaders::PhongGL::Flag::InstancedTransformation};
    _fireBuffer = GL::Buffer{};
    _fireMesh.addVertexBufferInstanced(_fireBuffer, 1, 0, Shaders::PhongGL::TransformationMatrix{}, Shaders::PhongGL::NormalMatrix{}, Shaders::PhongGL::Color3{}, Shaders::PhongGL::ObjectId{});
    _fireMesh.setInstanceCount(_fireData.size());
    _fireMesh.setPrimitive(GL::MeshPrimitive::Triangles);
...
void Simulator::drawEvent() {
    ...
    /* ImGui */
    {
        ...
        static int PF_item_current_idx = 2;
    ...
    */
    ...
    _fireMesh.setInstanceCount(_fireData.size());
    _fireBuffer.setData(_fireData,GL::BufferUsage::DynamicDraw);
    _voxelShader.setProjectionMatrix(_projectionMatrix)
            .setTransformationMatrix(_arcballCamera->viewMatrix())
            .setLightPositions({{10.0f, 10.0f, 10.0f,0.0f}})
            .setNormalMatrix(_arcballCamera->viewMatrix().normalMatrix())
...
void Simulator::cleanVoxels(){
    ...
    _fireData.erase(_fireData.begin(), _fireData.end());
    _fireMesh.setInstanceCount(_fireData.size());
    _voxelMesh.setInstanceCount(_instanceData.size());
    _mtx.unlock();
}
