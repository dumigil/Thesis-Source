...
struct IMGUI_API ImGuiWindow
{
    ...
    ImGuiWindow*            RootWindow;                         // Voxel to ourself or first ancestor that is not a child window == Top-level window.
    ImGuiWindow*            RootWindowForTitleBarHighlight;     // Voxel to ourself or first ancestor which will display TitleBgActive color when this window is active.
    ImGuiWindow*            RootWindowForNav;                   // Voxel to ourself or first ancestor which doesn't have the NavFlattened flag.
