...
int main(int argc, char** argv){
    ...
    if(TILTED){
        ...
        file = "/Users/michieldejong/Documents/Graduation/Simulator/dataset_tilted/dataset_1_tilted_228x85x256.txt";
        meshfile = "/Users/michieldejong/Documents/Graduation/Simulator/dataset_tilted/dataset_1_tilted_228x85x256_fixed.obj";
    }else{
        rows = Rows(163, 101, 256);
        file = "/Users/michieldejong/Documents/Graduation/Simulator/dataset/dataset_2_163x101x256.txt";
        meshfile = "/Users/michieldejong/Documents/Graduation/Simulator/dataset/dataset_163_101_256_fixed_2.obj";
    }

    VoxelGrid voxelGrid(rows.x, rows.y, rows.z);
    const char *out = "/Users/michieldejong/Documents/Graduation/Simulator/dataset/walkable.txt";
    ...
    for(int l = 0; l < octree.mTree.size(); l++){
        int i = 0;
        for(auto nodes: octree.mTree[l]){
            if(nodes.second->isFull) i++;
            if(nodes.second->isLeaf) i++;
        }
        std::cout<<"Level "<<l<<" has "<<i<<" full nodes\n";
    }
